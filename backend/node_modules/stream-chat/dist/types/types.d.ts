...
export type BatchUpdateOperation = 'addMembers' | 'removeMembers' | 'inviteMembers' | 'assignRoles' | 'addModerators' | 'demoteModerators' | 'hide' | 'show' | 'archive' | 'unarchive' | 'updateData' | 'addFilterTags' | 'removeFilterTags';
...
export type UpdateChannelsBatchFilters = QueryFilters<{
    ...
    filter_tags?: RequireOnlyOne<Pick<QueryFilter<string>, '$in' | '$eq'>> | PrimitiveFilter<Record<string, string>>;
}>;
